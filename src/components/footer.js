            ...
            <div className={style.footerInner}>
                ...
                <div className={style.gnavi}>
                    ...
                    <ul>
                        ...
                        <li><Link to="/news/1" className={style.off}><span><FontAwesomeIcon icon={faMinus}/></span> 今後の例会・事業</Link></li>
                        <li><Link to="/past/1"><span><FontAwesomeIcon icon={faMinus}/></span> 過去の例会・事業</Link></li>
                        <li><Link to="/syokan/1" className={style.off}><span><FontAwesomeIcon icon={faMinus}/></span> 理事長所感</Link></li>
