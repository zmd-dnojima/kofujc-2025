...
const TermofService = () => {
    return(
        <Layout>
            <Seo title="ZMD｜利用規約" description="利用規約ページ" /> 
            ...
            <div className={style.wrapper}>
                ...
                <div className={style.container}>
                    <p>この利用規約（以下，「本規約」といいます。）は，Zero Mountain Design（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
                    <h4>第1条（適用）</h4>
                    ...
                    <h4>第7条（利用規約の変更）</h4>
                    <p> - 当社は以下の場合には、ユーザーの個別の同意を要せず、本規約を変更することができるものとします。<br/>
                        1. 本規約の変更がユーザーの一般の利益に適合するとき。<br/>
                        2. 本規約の変更が本サービス利用契約の目的に反せず、かつ、変更の必要性、変更後の内容の相当性その他の変更に係る事情に照らして合理的なものであるとき。<br/><br/>
                        - 当社はユーザーに対し、前項による本規約の変更にあたり、事前に、本規約を変更する旨及び変更後の本規約の内容並びにその効力発生時期を通知します。
                    </p>
                    <h4>第8条（個人情報の取扱い）</h4>
                    <p> 当社は，本サービスの利用によって取得する個人情報については，当社「<Link to="../privacypolicy" style={{textDecoration:"underline"}}>プライバシーポリシー</Link>」に従い適切に取り扱うものとします。
                    </p>
