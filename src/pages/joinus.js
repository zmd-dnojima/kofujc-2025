            ...
            <div className={style.main}>
                ...
                <div className={style.contentWrap}>
                    <div className={style.historyBody}>
                        ...
                        <p>〇コフィー・アナン（ガーナ）・・・第7代国連事務総長</p>
                        <p>〇ジャック・シラク（フランス）・・・フランス第5代大統領</p>
                        <p>〇ビル・ゲイツ（アメリカ）・・・マイクロソフト創業者</p>
                        <p>〇ビル・クリントン（アメリカ）・・・アメリカ合衆国第42代大統領</p>
                        <p>〇麻生　太郎・・・第92代内閣総理大臣</p>
                        <p>〇小泉　純一郎・・・第87,88,89代内閣総理大臣</p>
                        <p>〇森　喜朗・・・第85,86代内閣総理大臣</p>
                        <p>〇千　玄室・・・裏千家今日庵第15代家元</p>
                        <p>〇牛尾　治朗・・・ウシオ電機会長</p>
                        <p>〇服部　禮次郎・・・セイコー名誉会長</p>
