                ...
                <div className={style.contentWrap}>
                    <div className={style.historyBody}>
                        ...
                        <div className={style.summery}>
                            ...
                            <div>応募方法</div>
                            <div><a href="https://sgfm.jp/f/koihime2025" target="_blank">専用応募フォーム</a>からご応募ください。または、<a href="https://drive.google.com/file/d/1Lx1QP1Zt-27FeljocdGUJ0a6_8rf6zmv/view?usp=sharing" target="_blank">専用応募用紙</a>（こちらからダウンロードしてください）に必要事項を記入の上、一般社団法人甲府青年会譲所事務局宛にこ持参またはこ郵送ください。</div>
                            <div>スケジュール</div>
